...
public class ViewPickupLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pickup_location);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng pickupLocation = new LatLng(mPickupLocation.getLatitude(), mPickupLocation.getLongitude());
        mMap.addMarker(new MarkerOptions().position(pickupLocation).title("Pickup Location"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(pickupLocation, mZoomLevel));
    }
    ...
    protected void onStart() {
        ...
        mPickupLocation = (Geolocation) intent.getSerializableExtra(PICKUP_LOCATION);
    }
}
