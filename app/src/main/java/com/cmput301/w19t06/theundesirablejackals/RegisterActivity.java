        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txt_username) || TextUtils.isEmpty(txt_email)
                    ...
                    Toast.makeText(RegisterActivity.this, "Empty field must be filled", Toast.LENGTH_SHORT);

                } else if (txt_password.length() < 8) {
                    Toast.makeText(RegisterActivity.this, "Password must be 8 characters or more", Toast.LENGTH_SHORT);
                } else {
