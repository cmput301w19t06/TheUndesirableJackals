...
//                currentUser = FirebaseAuth.getInstance().getCurrentUser();
    ...
    private void registerInDatabase(final String username, final String phone){
        ...
        user.getOwnedBooks().addBook(new Book("TestBook1", "TUDJ", "1111111111"));
        user.getOwnedBooks().addBook(new Book("TestBook2", "TUDJ", "1111111111"));
        user.getOwnedBooks().addBook(new Book("TestBook3", "TUDJ", "1111111111"));
        user.getOwnedBooks().addBook(new Book("TestBook1", "TUDJ2", "1111111111"));
        user.getOwnedBooks().addBook(new Book("TestBook2", "TUDJ2", "1111111111"));
        user.getOwnedBooks().addBook(new Book("TestBook3", "TUDJ2", "1111111111"));
        user.getOwnedBooks().addBook(new Book("TestBook1", "TUDJ2", "1111111112"));
        user.getOwnedBooks().addBook(new Book("TestBook2", "TUDJ2", "1111111112"));
        user.getOwnedBooks().addBook(new Book("TestBook3", "TUDJ2", "1111111112"));
